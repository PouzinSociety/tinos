/*
 * $Id: IPv4ConfigurationService.java 4214 2008-06-08 04:37:59Z crawley $
 *
 * JNode.org
 ...
 *                 - Added netmask to Add/Delete route.
 *
 */
...
public interface IPv4ConfigurationService {
     ...
     * @throws NetworkException
     */
    public void addRoute(IPv4Address target, IPv4Address netmask, IPv4Address gateway, Device device, boolean persistent)
        throws NetworkException;
     ...
     * @throws NetworkException
     */
    public void deleteRoute(IPv4Address target, IPv4Address netmask, IPv4Address gateway, Device device)
        throws NetworkException;
}
