/*
 * $Id: ARPNetworkLayer.java 4241 2008-06-15 12:50:44Z lsantha $
 *
 * JNode.org
 ...
 *                 - removed vm.annotation.SharedStatics - not supported.
 *
 */
 ...
 * @author epr
 */
public class ARPNetworkLayer implements NetworkLayer, ARPConstants, ARPService {
    private static final boolean DEBUG = false;

    /**
     * My logger
     */
    private static final Log log = LogFactory.getLog(ARPNetworkLayer.class);
    /**
     * My statistics
     */
    ...
    public void receive(SocketBuffer skbuf, NetDeviceAPI deviceAPI) throws SocketException {
        ...
        // Update the cache
	log.debug("src:" + hdr.getSrcHWAddress() + " - SrcP : " + hdr.getSrcPAddress());
