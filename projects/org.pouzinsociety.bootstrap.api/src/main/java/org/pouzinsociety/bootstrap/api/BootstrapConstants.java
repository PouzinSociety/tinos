...
public interface BootstrapConstants {
	...
	public static final int NOT_SET  = 0x0000;   /* Not Set - UnInitialised */
	public static final int CONFIG_REQUEST  = 0x0001;   /* Configuration Request */
	public static final int CONFIG_RESPONSE = 0x0002;   /* Configuration Response */
}
