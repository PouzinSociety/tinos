/*
 * $Id: Device.java 4153 2008-05-30 12:20:45Z lsantha $
 *
 * JNode.org
...
public class Device implements ResourceOwner {
    ...
    protected final void fireStartedEvent() {
        ...
        for (DeviceListener l : listeners) {
            ...
            if (sw.isElapsedLongerThen(100)) {
                logger.error("DeviceListener took " + sw + " in deviceStarted: " + l.getClass().getName());
            }
        }
    ...
    protected final void fireStopEvent() {
        ...
        for (DeviceListener l : listeners) {
            ...
            l.deviceStop(this);
            if (sw.isElapsedLongerThen(100)) {
                logger.error("DeviceListener took " + sw + " in deviceStop: " + l.getClass().getName());
            }
        }
    }
