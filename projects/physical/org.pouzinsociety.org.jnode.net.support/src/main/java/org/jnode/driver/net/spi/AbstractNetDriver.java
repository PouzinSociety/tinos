/*
 * $Id: AbstractNetDriver.java 4157 2008-05-30 14:55:37Z hagar-wize $
 *
 * JNode.org
...
public abstract class AbstractNetDriver extends Driver
     ...
     * My logger
     */
    private static final Log log = LogFactory.getLog(AbstractNetDriver.class);
    /**
    ...
    protected void startDevice() throws DriverException {
      ...
      final DeviceManager dm = device.getManager();
        try {
