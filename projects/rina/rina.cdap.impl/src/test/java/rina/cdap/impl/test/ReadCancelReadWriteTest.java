...
public class ReadCancelReadWriteTest extends BaseCDAPTest{
	...
	public void testSingleWriteWithResponse() throws CDAPException{
		...
		cdapMessage = CDAPMessage.getWriteObjectRequestMessage(null, null, 25, "org.pouzinsociety.flow.Flow", 0, new byte[]{101}, "123", 0);
	...
	public void testSingleWriteWithoutResponse() throws CDAPException{
		...
		cdapMessage = CDAPMessage.getWriteObjectRequestMessage(null, null, 0, "org.pouzinsociety.flow.Flow", 0, new byte[]{101}, "123", 0);
		message = sendingCDAPSession.serializeNextMessageToBeSent(cdapMessage);
		sendingCDAPSession.messageSent(cdapMessage);
	...
	public void testMultipleWriteWithResponses() throws CDAPException{
		...
		cdapMessage = CDAPMessage.getWriteObjectRequestMessage(null, null, 2, "org.pouzinsociety.flow.Flow", 0, new byte[]{101}, "123", 0);
		message = sendingCDAPSession.serializeNextMessageToBeSent(cdapMessage);
		sendingCDAPSession.messageSent(cdapMessage);
		
		receivingCDAPSession.messageReceived(message);
		
		cdapMessage = CDAPMessage.getWriteObjectRequestMessage(null, null, 3, "org.pouzinsociety.flow.Flow", 0, new byte[]{101}, "789", 0);
		message = sendingCDAPSession.serializeNextMessageToBeSent(cdapMessage);
		sendingCDAPSession.messageSent(cdapMessage);
