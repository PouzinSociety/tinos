...
public class DIFRegistrationSetRIBObject extends BaseRIBObject{
	...
	public DIFRegistrationSetRIBObject(NMinus1FlowManager nMinus1FlowManager, IPCProcess ipcProcess){
	...
	public void create(String objectClass, long objectInstance, String objectName, Object object) throws RIBDaemonException{
		...
		DIFRegistrationRIBObject ribObject = new DIFRegistrationRIBObject(this.getIPCProcess(), objectName, 
