 ...
 *
 * MODIFIED FOR RINA
 * If a port number equal or greater than FAUX_SOCKETS_PORT_VALUE is used, the value of 
 * FAUX_SOCKETS_PORT_VALUE is substracted from it and the usual regular sockets are used.
 * Otherwise, the RINASocketImpl is used
 * END MODIFIED FOR RINA
 *
 * @author  unascribed
...
public
class Socket {
	public static final int FAUX_SOCKETS_PORT_VALUE = 70000;
    ...
    protected Socket(SocketImpl impl, boolean useRINA) throws SocketException {
    	this.useRINA = useRINA;
        this.impl = impl;
        if (impl != null) {
            checkOldImpl();
            this.impl.setSocket(this);
    ...
    {  	
        this(host != null ? new InetSocketAddress(host, port) :
             ...
             (SocketAddress) null, true, true);
    }
    
    public Socket(boolean useRINA, String host, int port) throws UnknownHostException, IOException {  	
    this(host != null ? new InetSocketAddress(host, port) :
         new InetSocketAddress(InetAddress.getByName(null), port),
         (SocketAddress) null, true, useRINA);
    }
    ...
    public Socket(String host, int port, InetAddress localAddr,
        ...
        this(host != null ? new InetSocketAddress(host, port) :
               new InetSocketAddress(InetAddress.getByName(null), port),
             new InetSocketAddress(localAddr, localPort), true, true);
    }
    ...
    public Socket(String host, int port, boolean stream) throws IOException {
        this(host != null ? new InetSocketAddress(host, port) :
               new InetSocketAddress(InetAddress.getByName(null), port),
             (SocketAddress) null, stream, true);
    }
    ...
    public Socket(InetAddress host, int port, boolean stream) throws IOException {
        this(host != null ? new InetSocketAddress(host, port) : null,
             new InetSocketAddress(0), stream, true);
    }

    private Socket(SocketAddress address, SocketAddress localAddr,
                   boolean stream, boolean useRINA) throws IOException {
    	this.useRINA = useRINA;
    	setImpl();
