...
class ServerSocket {
    ...
    /**
     * Are we using the RINA sockets implementation?
     */
    ...
    public ServerSocket(boolean useRINA) throws IOException {
    ...
    public ServerSocket(int port) throws IOException {
        this(port, 50, null, true);
    }
    
    public ServerSocket(int port, boolean useRINA) throws IOException {
        this(port, 50, null, useRINA);
    }
     ...
     * @since   JDK1.1
     */
    public ServerSocket(int port, int backlog, InetAddress bindAddr, boolean useRINA) throws IOException {
    	this.useRINA = useRINA;
        setImpl();
    ...
    private void setImpl() {
    	log.info("Sockets modified version");
    	/* Modified for RINA*/
    	if (useRINA){
    ...
    public Socket accept() throws IOException {
        ...
        if (useRINA){
        	SocketImpl socketImpl = ((RINASocketImpl)this.impl).accept();
        	Socket s = new Socket(socketImpl, true);
        	s.postAccept();
        	return s;
        }else{
