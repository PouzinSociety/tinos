...
public abstract class CDAPClient {
	...
	public void run(){
		try {
			...
			CDAPMessage message = CDAPMessage.getOpenConnectionRequestMessage(AuthTypes.AUTH_NONE, null, null, "default_enrollment", "1","i2CAT-Barcelona", 15, null, null , "1", "TSSG-Waterford");
