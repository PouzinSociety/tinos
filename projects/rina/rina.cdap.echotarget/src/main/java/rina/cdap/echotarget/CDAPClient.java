...
public abstract class CDAPClient {
	...
	public void run(){
		try {
			...
			CDAPMessage message = CDAPMessage.getOpenConnectionRequestMessage(AuthTypes.AUTH_NONE, null, null, "default_enrollment", null,"RINA-Demo.DIF", 15, null, null , "1", "TSSG-Waterford");
