...
public class Zone implements Serializable {
	 ...
	 */
	public
	Zone(Name zone, InputStream inputStream) throws IOException {
		data = new TreeMap();

		if (zone == null)
			throw new IllegalArgumentException("no zone name specified");
		Master m = new Master(inputStream, zone, -1);
		Record record;
	 ...
	 */
	public
	Zone(Name zone, String fileName) throws IOException {
		data = new TreeMap();

		if (zone == null)
			throw new IllegalArgumentException("no zone name specified");
		Master m = new Master(fileName, zone, -1);
		Record record;
