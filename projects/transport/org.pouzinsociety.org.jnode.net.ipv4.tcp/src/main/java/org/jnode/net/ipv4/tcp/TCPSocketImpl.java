/*
 * $Id: TCPSocketImpl.java 4241 2008-06-15 12:50:44Z lsantha $
 *
 * JNode.org
...
public class TCPSocketImpl extends SocketImpl {
     ...
     * My logger
     */
    private static final Log log = LogFactory.getLog(TCPSocketImpl.class);
    ...
    protected void bind(InetAddress host, int port) throws IOException {
    	log.debug("TCPSocketImpl: Bind: " + host.toString() + ":" + port);
        if (controlBlock != null) {
