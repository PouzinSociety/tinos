...
# Add tests
src_path = "/" + test_organization.gsub('.','/')
...
puts "\n\tNote:"
puts "\n\t\tTo generate the .classpath file for eclipse:"
puts "\n\t\tcd " + test_target_folder + "; ant eclipse\n\n"
puts "\n\n\tRunning Integration Test Bundle:"
puts "\n\t\t1. Build Bundle to be tested"
puts "\n\t\t\tcd " + target_folder + "; ant clean jar"
puts "\n\t\t2. Run the integration test"
puts "\n\t\t\tcd " + test_target_folder + "; ant clean test"
puts "\n\n\tThe integration test bundle is only a very simple example where the bundle"
puts "\tto be tested is loaded in an OSGI environment and service test is performed."
puts "\tIt is optional to supply an integration test bundle but it is sometimes useful"
puts "\tfor testing in a standalone OSGI env. It is still a little rough but the basics"
puts "\twork."
